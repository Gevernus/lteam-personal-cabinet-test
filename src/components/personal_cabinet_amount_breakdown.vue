...
<style scoped>
.personal-cabinet-amount-breakdown {
  height: 214px;
  padding: 20px;
...
.personal-cabinet-amount-breakdown dl {
  margin: 0;
  padding-top: 15px;
  border-top: 1px solid rgb(36 145 170 / 30%);
}

.personal-cabinet-amount-breakdown dl div {
  display: flex;
  height: 17px;
  align-items: center;
...
.personal-cabinet-amount-breakdown dl div + div {
  margin-top: 8px;
}
